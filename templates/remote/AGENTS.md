...
`remote` template. It uses Nix flakes with devenv for a reproducible developer
environment, configured for remote development.
...
- `.envrc` — direnv entry point (remote-specific configuration)
